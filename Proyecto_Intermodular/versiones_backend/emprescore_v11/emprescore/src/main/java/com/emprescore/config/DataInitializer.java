            ...
            if (empresaRepository.count() == 0) {
                ...
                if (resenaRepository.count() == 0 && user1 != null) {
                    ...
                    List<String[]> resenasData = List.of(
                        ...
                        new String[]{"Muy buen restaurante", "La comida estaba muy buena y el servicio fue rápido y atento. Volvería sin duda.", "4", "0"},
                        new String[]{"Mejorable", "El local estaba bien pero la atención podría mejorar bastante. Esperaba más.", "3", "0"},
                        new String[]{"Gran empresa tech", "Nos desarrollaron una app excelente, muy profesionales y puntuales.", "5", "2"},
                        new String[]{"Buenos desarrolladores", "Cumplieron con los plazos y el resultado fue muy bueno. Recomendables.", "4", "2"},
