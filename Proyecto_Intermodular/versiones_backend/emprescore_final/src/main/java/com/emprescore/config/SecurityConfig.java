...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/usuarios/*").authenticated() // eliminar cuenta 
                .requestMatchers("/api/usuarios/reset-password").permitAll() // reseteo de contraseña abierto
                .requestMatchers("/api/usuarios/**").hasRole("ADMIN") // sólo admin puede listar usuarios
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/resenas/*").authenticated() //edita reseña autenticado
