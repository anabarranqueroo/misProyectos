...
export class Profile implements OnInit {
  ...
  mostrarConfirmacionEmpresa: boolean = false;
  ...
  abrirModalEliminarEmpresa(): void {
    this.mostrarConfirmacionEmpresa = true;
  }

  cerrarModalEliminarEmpresa(): void {
    this.mostrarConfirmacionEmpresa = false;
  }

  confirmarEliminarEmpresa(): void {
    if (!this.miEmpresa?.id) return;
    this.empresaServicio.borrar(this.miEmpresa.id).subscribe({
      next: () => {
        this.miEmpresa = null;
        this.mostrarConfirmacionEmpresa = false;
      },
